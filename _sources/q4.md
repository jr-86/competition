...
*My apologies to the reader, I just wanted to see the equation written in full. At this point I would like to note that decades of mathematical experience are telling me to give up on algebra and approach this numerically. I would say that the chances of the above formula simplifying nicely are minimal.*

Before resorting to numerical approximations, we will try a final programmatic approach to find a simplified version of the above, using the sympy Python package in the following code:
